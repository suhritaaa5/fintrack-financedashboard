...
const TransactionsTable = ({ transactions, isAdmin }) => {
  ...
  return (
    <div>
        ...
        <div className="flex flex-wrap gap-2 w-full md:w-auto">
          <Select value={typeFilter} onValueChange={setTypeFilter}>
            ...
            <SelectContent className="bg-orange-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 shadow-lg rounded-md">
              <SelectGroup>
                <SelectItem value="ALL" className="cursor-pointer text-slate-900 dark:text-slate-200 focus:bg-orange-200 dark:focus:bg-slate-700">All Types</SelectItem>
                <SelectItem value="INCOME" className="cursor-pointer text-slate-900 dark:text-slate-200 focus:bg-orange-200 dark:focus:bg-slate-700">Income</SelectItem>
                <SelectItem value="EXPENSE" className="cursor-pointer text-slate-900 dark:text-slate-200 focus:bg-orange-200 dark:focus:bg-slate-700">Expense</SelectItem>
              </SelectGroup>
            </SelectContent>
          </Select>
          ...
          <Select value={recurringFilter} onValueChange={setRecurringFilter}>
            ...
            <SelectContent className="bg-orange-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 shadow-lg rounded-md">
              <SelectGroup>
                <SelectItem value="ALL" className="cursor-pointer text-slate-900 dark:text-slate-200 focus:bg-orange-200 dark:focus:bg-slate-700">All Transactions</SelectItem>
                <SelectItem value="recurring" className="cursor-pointer text-slate-900 dark:text-slate-200 focus:bg-orange-200 dark:focus:bg-slate-700">Recurring Only</SelectItem>
                <SelectItem value="non-recurring" className="cursor-pointer text-slate-900 dark:text-slate-200 focus:bg-orange-200 dark:focus:bg-slate-700">Non-Recurring Only</SelectItem>
              </SelectGroup>
            </SelectContent>
          </Select>
      ...
      {/* Table wrapper
          IMPORTANT: overflow-x and overflow-y must be on the SAME div.
          If they're on separate nested divs, sticky positioning breaks
          because the header is sticky relative to its own scroll container,
          not the outer one. Single container fixes both axes. */}
      <div className="relative">
        {/* Mobile right-edge scroll hint */}
        <div className="pointer-events-none absolute inset-y-0 right-0 w-6 bg-gradient-to-l from-orange-50/80 dark:from-slate-800/80 to-transparent md:hidden z-20 rounded-r" />

        <div className="w-full overflow-x-auto overflow-y-auto max-h-[500px] scrollbar-none rounded bg-orange-50/80 dark:bg-slate-800/80">
          <Table className="min-w-[700px] md:min-w-[900px] table-fixed text-sm md:text-base">
            {/* Sticky header — bg must be solid so rows don't bleed through */}
            <TableHeader className="sticky top-0 z-20">
              <TableRow className="border-slate-800 dark:border-slate-600 bg-orange-50 dark:bg-slate-800">
                {isAdmin && (
                  <TableHead className="px-2 md:px-3 py-2 md:py-3 w-[40px] align-middle bg-orange-50 dark:bg-slate-800">
                    <Checkbox
                ...
                <TableHead
                  className="w-[90px] cursor-pointer px-2 md:px-3 py-3 text-left bg-orange-50 dark:bg-slate-800"
                ...
                <TableHead className="w-[100px] md:w-[160px] px-2 md:px-3 py-3 align-middle font-bold text-slate-800 dark:text-slate-100 bg-orange-50 dark:bg-slate-800">
                  Description
                </TableHead>

                <TableHead
                  className="px-2 md:px-3 py-3 align-middle w-[100px] cursor-pointer bg-orange-50 dark:bg-slate-800"
                ...
                <TableHead
                  className="px-2 md:px-3 py-3 w-[80px] text-right cursor-pointer bg-orange-50 dark:bg-slate-800"
                ...
                <TableHead className="px-2 md:px-3 py-3 w-[100px] align-middle font-bold text-slate-800 dark:text-slate-100 bg-orange-50 dark:bg-slate-800">
                  Recurring
                </TableHead>

                {isAdmin && (
                  <TableHead className="w-[40px] bg-orange-50 dark:bg-slate-800" />
                )}
              </TableRow>
            </TableHeader>
